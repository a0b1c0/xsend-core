...
(function() {
     ...
     * @returns {string}
     */
    __exports.qr_svg = function(content, options) {
        let deferred3_0;
        let deferred3_1;
        try {
     ...
     * @enum {0 | 1 | 2}
     */
    __exports.ImageBackgroundShape = Object.freeze({
        /**
         * Square shape
         */
        Square: 0, "0": "Square",
     ...
     */
    __exports.Version = Object.freeze({
        /**
         * Version n°01
         */
        V01: 0, "0": "V01",
    ...
    __exports.SvgOptions = SvgOptions;
